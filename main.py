...
class bcolors:
    ...
    #TheSadError Repo
os.system("clear")
os.system("figlet OSTERA | lolcat")
print(f"{bcolors.FAIL}This Tool Created By Error")
print(f"{bcolors.FAIL}Github  : https://github.com/Jokergazaa ")
print(f"{bcolors.FAIL}Discord : err0r#4018")
print(" ")
print(f"{bcolors.OK}[OSTERA] Welcome to - JOKER-OSTERA-")
print(" ")
print(f"{bcolors.OK}[OSTERA]  This tool must be run by the Palestinian Joker...")
print(" ")
...
print(" ")
i = input(f"{bcolors.OK}[MENU] Please specify the operation number with my tools : ") # Error
if i=="1":
    ...
    print(f"{bcolors.FAIL}This Tool Created By Error")
    print(f"{bcolors.FAIL}Github  :https://github.com/Jokergazaa  ")
    print(f"{bcolors.FAIL}Discord : JOKER.PLSTAEEN")
